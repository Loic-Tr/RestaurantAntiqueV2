...
<article>
    <div class="container p-4">
        ...
        <div class="row row-cols-2 align-items-center">
            ...
            <div class="col">
                <img class="w-100 rounded" src="../images/chef.jpg" alt="Chef Arnaud Michant" title="Chef Arnaud Michant"/>
            </div>
        </div>
        <div class="text-center pt-4">
            <a href="/carte" class="btn btn-primary">Nos menus</a>
        </div>
    </div>
</article>
...
<article class="bg-black text-white">
        <div class="container p-4">
            ...
            <div class="row row-cols-2 align-items-center">
                <div class="col">
                    <img class="w-100 rounded" src="../images/saumon.jpg" alt="Saumon frais, plat du jour" title="Saumon frais, plat du jour"/>
                </div>
                <div class="col">
                    <p class="text-justify">
            ...
            <div class="text-center pt-4">
                <a href="/galerie" class="btn btn-primary" data-link>Voir la galerie</a>
            </div>
        </div>
    </article>
</template>
